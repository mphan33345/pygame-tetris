...
class Tetris:
    ...
    def game_over(self):
        box = pygame.Rect(40,100,WIDTH-80,HEIGHT-350)
        pygame.draw.rect(win, BLACK, box)
        pygame.draw.rect(win, RED, box, 2)


        # Create three lines of text
        gameoverimg = font.render('Game Over!', True, WHITE)
        restartimg = font2.render('Press R to restart', True, WHITE)
        quitimg = font2.render('Press ESC to quit', True, WHITE)
        
        # Blit three lines of text
        win.blit(gameoverimg, (box.centerx-gameoverimg.get_width()//2, box.y+20))
        win.blit(restartimg, (box.centerx-restartimg.get_width()//2, box.y+75))
        win.blit(quitimg, (box.centerx-quitimg.get_width()//2, box.y+105 ))
